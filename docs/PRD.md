...
2.  **Adaptive Multi-Provider Intelligence**: The agent utilizes both Anthropic Claude 4.6 and local Ollama models. It plans complex engineering tasks and modulates effort based on task difficulty.
