...
export type ComputerAction =
  ...
  | { action: 'scroll'; coordinate: [number, number]; scroll_direction: ScrollDirection; scroll_amount: number; text?: string }
...
export interface ComputerInterface {
   ...
   */
  scroll(x: number, y: number, direction: ScrollDirection, amount: number, modifier?: string): Promise<void>;
