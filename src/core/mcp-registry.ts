...
export const MCP_REGISTRY: Record<string, MCPServerDefinition> = {
	filesystem: {
		name: 'filesystem',
		description:
			'Access local files and directories outside the workspace (requires permission)',
		command: 'npx',
	...
	research: {
		name: 'research',
		description:
			'Search the web using Brave Search. Excellent for docs and current info.',
		command: 'npx',
	...
	context7: {
		name: 'context7',
		description:
			'Official documentation search and retrieval (Certified Correct Docs)',
		command: 'npx',
