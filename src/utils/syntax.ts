...
// Built-in types
const TYPES = ['string', 'number', 'boolean', 'object', 'any', 'void', 'never', 'unknown', 'Array', 'Promise', 'Map', 'Set', 'Record', 'Partial', 'Required', 'Readonly'];
 ...
 */
export function highlightCodeBlock(code: string, lang: string = 'default'): string {
...
export interface ContentSegment {
    type: 'text' | 'code' | 'inline-code' | 'heading' | 'list' | 'bold' | 'italic';
    content: string;
    lang?: string;
}
